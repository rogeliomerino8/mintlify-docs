...
- **Ver lista de clientes**: Visualiza todos los clientes asociados a tu despacho.
- **Ver proyectos**: Accede a la organización por carpetas de cada cliente.
...
La sección de Proyectos te permite gestionar la organización por carpetas de tus clientes.
...
1. En el formulario del lado izquierdo, completa los siguientes campos:
   - **Proyecto** (obligatorio): Nombre de la carpeta de organización.
